...
{
  const { inPeriod } = require('./src/logic');
  const p = { startDate: '19-08-2026', endDate: '20-08-2026' };
  assert.strictEqual(inPeriod('18-08-2026 23:59:59', p), false);
  assert.strictEqual(inPeriod('19-08-2026 00:00:00', p), true);
  assert.strictEqual(inPeriod('20-08-2026 23:59:59', p), true);
  assert.strictEqual(inPeriod('21-08-2026 00:00:00', p), false);
}
console.log('period tests: OK');
