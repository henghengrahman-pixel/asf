...
(
  cd /app/internal_dp_checker
  PORT="$DP_INTERNAL_PORT" BIND_HOST="127.0.0.1" DATA_DIR="$DATA_DIR/dp_checker" INTERNAL_TRUST_TOKEN="$DP_INTERNAL_TOKEN" SESSION_SECRET="${SESSION_SECRET:-${SECRET_KEY:-marketing8008-dp-session-2026}}" node src/server.js
) &
DP_PID=$!
